...
// Timers Synthétiseur de frequence resolution 250uS
...
//	  pthread_mutex_lock (&my_mutex);
	 ...
	 // Evaluation timer synthétiseur de fréquence
	 ...
	 // Evaluation timer pour génération dutycycle HIGH
	 if(tmr_BuzzDutyCnt>=tmr_BuzzDutyHighTarget){
		 th6_timerBuzzDutyHighReadyFlag=1;
	 }
	 // Evaluation timer pour génération dutycycle LOW
